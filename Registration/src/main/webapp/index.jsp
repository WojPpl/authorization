...
<div class="uk-vertical-align uk-text-center uk-height-1-1">
    <div class="uk-vertical-align-middle" style="width: 400px;">
        ...
        <form class="uk-panel uk-form" action="register" method="post">
            ...
            <div class="uk-form-row">
                <input class="uk-width-1-1 uk-form-large" type="password" placeholder="Confirm Password" name="cpassword">
            </div>
            <div class="uk-form-row">
                <input class="uk-width-1-1 uk-form-large" type="email" placeholder="Email" name="email">
            </div>
            <div class="uk-form-row">
                <button class="uk-width-1-1 uk-button uk-button-primary uk-button-large">Register</button>
            </div>
            <div class="uk-margin-top"><a href="/login" >Click here to login</a></div>
        </form>
